...
public class Constants {
    ...
    public static final String VALIDATION_REGEX_PSD = "(\\d+p)(\\s([0-9]|1[0-9]|20)s)?(\\s([0-9]|1[0-2])d)?";
    public static final String VALIDATION_REGEX_SD = "(([0-9]|1[0-9]|20)s)?(\\s([0-9]|1[0-2])d)?";
    public static final String VALIDATION_REGEX_D = "(([0-9]|1[0-2])d)?";
